	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			for (int i = 0; i < trials; i++) {
				Document basic = new BasicDocument(str);
				double basfle = basic.getFleschScore();
			}
			...
			starttime = System.nanoTime();
			for (int i = 0; i < trials; i++) {
				Document effic = new EfficientDocument(str);
				double efffle = effic.getFleschScore();
			}
			endtime = System.nanoTime();
			...
			//System.out.println("Flesch score = "+basfle+"\t"+efffle);
			//System.out.println(numSentences, numWords numSyllables);
